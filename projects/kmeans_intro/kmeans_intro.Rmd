...
This dataset, provided by the `ISLR` library is called `Default`. It consists of four variables: `default`, `student`, `balance`, and `income`. I will create a new group by combining student and default for visualization purposes.  Let's see how well *K-Means* can cluster these observations.
